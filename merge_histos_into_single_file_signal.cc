...
int main(int argc, char** argv) {
  ...
  vars.push_back("ev_Mvis_realtau_nominalMtHigh");  vars_out.push_back("Mvis");        
  vars.push_back("ev_Mcol_realtau_nominalMtHigh");  vars_out.push_back("Mcol");
  vars.push_back("ev_Mtot_realtau_nominalMtHigh");  vars_out.push_back("Mtot");
