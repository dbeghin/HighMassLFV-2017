...
int main(/*int argc, char** argv*/) {
  ...
  sig_names.push_back("QBH_200_");     
  sig_names.push_back("QBH_400_");     
  sig_names.push_back("QBH_600_");     
  sig_names.push_back("QBH_800_");     
  sig_names.push_back("QBH_1000_");     
  sig_names.push_back("QBH_2000_");     
  sig_names.push_back("QBH_3000_");     
  sig_names.push_back("QBH_4000_");     
  sig_names.push_back("QBH_5000_");     
  sig_names.push_back("QBH_6000_");     

  sig_names.push_back("RPV_l001_200_");     
  sig_names.push_back("RPV_l001_400_");     
  sig_names.push_back("RPV_l001_600_");     
  sig_names.push_back("RPV_l001_800_");     
  sig_names.push_back("RPV_l001_1000_");     
  sig_names.push_back("RPV_l001_2000_");     
  sig_names.push_back("RPV_l001_3000_");     
  sig_names.push_back("RPV_l001_4000_");     
  sig_names.push_back("RPV_l001_5000_");     

  sig_names.push_back("ZPrime_500_");     
  sig_names.push_back("ZPrime_700_");     
  ...
  sig_names.push_back("ZPrime_5000_");	   
  ...
  for (unsigned int k=0; k<n_signal; ++k) { 
    if (vars[k] != "ev_Mcol") continue;
    for (unsigned int l=0; l<Mth.size(); ++l) {
      for (unsigned int j=0; j<sig_names.size(); ++j) {
	cout << sig_names[j] << endl;
	if (l!=0) continue;
