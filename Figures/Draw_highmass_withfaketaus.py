...
def make_plot(var_out, Data, DY, TT, VV, Faketau, Faketau_high, Faketau_low, Faketau_topreweight_high, Faketau_topreweight_low, TT_topreweight_high, TT_topreweight_low):
...
for k in range (0,nvar):
    ...
    for l in range (0,len(Mth)):
        ...
        make_plot(var_in, Data, DY, TT, VV, Faketau, Faketau_high, Faketau_low, Faketau_topreweight_high, Faketau_topreweight_low, TT_topreweight_high, TT_topreweight_low)
        ...
        if "MtLow_SS" in var_in:
            ...
            make_plot(var[k]+"_MtLow", Data_MtLow, DY_MtLow, TT_MtLow, VV_MtLow, Faketau_MtLow, Faketau_high_MtLow, Faketau_low_MtLow, Faketau_topreweight_high_MtLow, Faketau_topreweight_low_MtLow, TT_topreweight_high_MtLow, TT_topreweight_low_MtLow)
