...
hadd -f Arranged_WJets/WJets_inclusive.root Out_WJets*madgraph*/Con*.root 
hadd -f Arranged_WJets/WJets_100to250.root Out_WJets*100To250*/Con*.root 
hadd -f Arranged_WJets/WJets_250to400.root Out_WJets*250To400*/Con*.root 
hadd -f Arranged_WJets/WJets_400to600.root Out_WJets*400To600*/Con*.root 
hadd -f Arranged_WJets/WJets_600toInf.root Out_WJets*600ToInf*/Con*.root 
